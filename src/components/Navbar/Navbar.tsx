...
export function Navbar() {
   ...
   Navbar = () => {
    ...
    return (
        ...
        <nav className={show ? styles.navbar : styles.hidden} id={"Navbar"} >
            ...
            <div className={styles.navlinks} id={"Navlinks"}>
                <Link href="/projects" passHref >
                    ...
                    <Dropdown heading="Join Us">
                        <Link href="/partner" ><a onClick={closeNav}>Partnering</a></Link>
                        <p> See what we can help you with </p>
                        <Link href="/volunteer" ><a onClick={closeNav}>Volunteering</a></Link>
                ...
                <Link href="/donate" passHref>
                    <a>
                        <button className={styles.btn} onClick={closeNav}>Donate</button>
                    </a>
                </Link>
            </div>
